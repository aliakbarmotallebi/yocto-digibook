<div class="container py-3">
  ...
  <div>
    <form class="input-group mb-3" action="<?= route('main.index') ?>" method="get">
      <input type="text" class="form-control" name="search" placeholder="جستجو براساس عنوان کتاب" value="<?= old('search') ?>">
